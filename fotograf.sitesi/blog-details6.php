...
<html lang="en">
  ...
  <head>
    ...
    <link href="./safranbolu.css" rel="stylesheet">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="text-content">
              <h4><i class="fa fa-user"></i> YUNUS ACARCA &nbsp;&nbsp;&nbsp;&nbsp;  <i class="fa fa-calendar"></i> 12/06/2020 10:30   &nbsp;&nbsp;&nbsp;&nbsp; <i class="fa fa-eye"></i> 114</h4>
              <h2>SAFRANBOLU</h2>
            </div>
          </div>
        </div>
    ...
    <div class="products">
      <div class="container">
        <div class="row">
            ...
            <div class="col-md-8">
                <p> Safranbolu, Karabük ilinin tarihi ve turistik bir ilçesidir. Konumu Ankara'nın 231 km kuzeyinde ve Karadeniz'in 90 km güneyindedir. Karabük ilçe merkezinin de 8 km [2] kuzeyinde bulunmaktadır. Safranbolu şehir merkezi ve Karabük il merkezi birbirine bitişiktir. <br>
                ...
                <h5>KARABÜK'ÜN GÜZELLİĞİ SAFRANBOLU</h5>

                <br>

                <p> Roma İmparatorluğu'n da Paflagonya olarak adlandırılan bölgede bulunur ve birçok medeniyete ev sahipliği yapmıştır. Türkler tarafından kesin olarak alınışı 1196 yılındadır. Osmanlı zamanında 17. yüzyılda İstanbul-Sinop yolu üzerinde olması nedeniyle tarihteki en önemli dönemini yaşamıştır.

2002'de kurulan Zonguldak Karaelmas Üniversitesi'ne bağlı Fethi Toker Güzel Sanatlar ve Tasarım Fakültesi, Safranbolu Meslek Yüksek Okulu ve Safranbolu Turizm Fakültesi bulunmaktadır. Şu anda ise bu fakülteler Karabük Üniversitesi'ne bağlıdır. <br>

                <br>
               SAFRANBOLU'DA YAPTIĞIMIZ ÇEKİMLER</p>
            </div>
            ...
            <div class="col-md-4">
              <div class="left-content">
                ...
                <p>GÜZEL ÜLKEMİZİN  GÜZELLİKLERİNDEN BİRİ OLAN SAFRANBOLU'YU ADIM ADIM GEZEREK MÜKEMMEL MANZARALARINI KADRAJLAYARAK SİZLERE GÖSTERMEK İSTEDİM.<S></S>
                </p>
