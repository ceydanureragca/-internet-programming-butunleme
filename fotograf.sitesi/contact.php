        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item active"><a class="nav-link" href="contact.php">BİZE ULAŞIN</a></li>
      ...
      <div class="container">
        <div class="row">
            ...
            <div class="contact-form">
              <form id="contact" action="" method="post">
                <div class="row">
                  ...
                  <div class="col-lg-12">
                    <fieldset>
                      <button type="submit" name="form-submit" class="filled-button">Send Message</button>
                    </fieldset>
                  </div>
                </div>
              </form>
          ...
          <div class="col-md-4">
            ...
            <h5 class="text-center" style="margin-top: 15px;">İBRAHİM ÖZEMİR</h5>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="inner-content">
              <p>Copyright © 2020 KADRAJ PHOTOGRAPHY  <a href="https://www.phpjabbers.com/"></a></p>
            </div>
          </div>
        </div>
      </div>
